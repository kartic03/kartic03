...
<a href="#kartic03-profile"><img alt="Kartic - AI protein design to expression and in vitro validation" src="./dist/header-dark.svg" width="{col}"></a>

<a href="#kartic03-profile"><img alt="Contribution calendar as an arcade shooter: empty days destroyed, contribution pattern revealed" src="./dist/shooter-dark.svg" width="{col}"></a>
